...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 13 20:21:11 2016
...
for l in range(mint,maxt):
    ...
    print "Accuracy for " + str(l) + " neighbors is - " + str(100*correct/10.0) + " percent"
    k_list.append(correct/10.0)

maxi = max(k_list)
ind = k_list.index(maxi)
print "\nMax accuracy with " + str(ind+mint) + " neighbors"
print "Accuracy rate obtained - " + str(100 * maxi) + " percent"